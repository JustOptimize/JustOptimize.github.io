var Projects = [
	{
		...
		dateEnd: null,
		description:
			'A plugin for BetterDiscord that allows users to view information about hidden channels in a Discord server, such as their name, description and which roles or users have access to these hidden channels.<br><br>Please note that this plugin will not allow you to read the messages in these channels, it will only show you information about them.',
		links: [
			{
				name: 'GitHub',
		...
		icon: '/assets/images/projects/SHC/Icon.svg',
	...
	},
	{
		...
		icon: '/assets/images/projects/RandomPasswordGenerator/Icon.png',
	...
	},
	{
		...
		icon: '/assets/images/projects/MySQL-Backup-Tool/Icon.png',
	...
	},
	{
		...
		icon: '/assets/images/projects/Pc-Cleaner/Icon.png'
	},
	{
		...
		icon: '/assets/images/projects/ABB/Icon.png',
		img: '/assets/images/projects/ABB/Banner.png'
	},
	{
		title: 'Evos Roleplay',
		...
		description:
			'A FiveM roleplay server I worked on for a few months, it was a great learning experience especially when it comes to Lua and SQL.<br><br>The main objectives were to create a unique server that was as optimized as possible, while still having a lot of features and a good looking UI.',
		links: [],

		icon: '/assets/images/projects/EvosRp/Icon.png',
		img: '/assets/images/projects/EvosRp/Banner.png'
	},
	{
		title: 'oSupport',
		dateStart: new Date(2023, 3, 1),
	...
	},
	{
		...
		dateEnd: new Date(2023, 5, 1),
		description:
			"A browser extention that replaces some urls with user declared ones when clicked<br><br>For example search.brave.com/search?q=abc -> google.com/search?q=abc<br><br>It is useful for when you want to use a different search engine but you don't want to change your default one or in development when you want to test a website on a different domain like localhost.",
		links: [],

		icon: '/assets/images/projects/URLConverter/Icon.png',
		img: '/assets/images/projects/URLConverter/Banner.png'
	},
	{
		title: 'Linkcord',
		dateStart: new Date(2023, 2, 1),
		dateEnd: new Date(2023, 5, 1),
		description:
			'Linkcord was a project that aimed to create an open-source, self-hosted alternative to the popular voice and text chat platform Discord.<br><br>It was a great learning experience, especially when it comes to networking and security.<br><br>Unfortunately, the project was discontinued since it was a school project',
		links: [],

		icon: '/assets/images/projects/Linkcord/Icon.png',
		img: '/assets/images/projects/Linkcord/Banner.png'
	},
	{
		...
		dateEnd: null,
		description:
			'A shop that sells scripts for FiveM servers, such as a custom ELS system, driving school, and more.<br><br>It also has a Discord server where users can buy the scripts at a discounted price and get support for them.',
		links: [
			{
				name: 'Discord',
		...
		icon: '/assets/images/projects/OggettoScripts/Icon.png',
		img: '/assets/images/projects/OggettoScripts/Banner.png'
	},
	{
		title: 'PreventiviBot - Invoices and tickets',
		dateStart: new Date(2023, 9, 1),
		dateEnd: null,
		description:
			'A Discord bot that allows users to generate invoices for their customers, manage products, and create tickets that are integrated with the invoice system.<br><br>It is a closed-source project.',
		links: [],

		icon: '/assets/images/projects/PreventiviBot/Icon.png',
		img: '/assets/images/projects/PreventiviBot/Banner.png'
	},
	{
		title: 'FiveLogs',
		...
		icon: '/assets/images/projects/FiveLogs/Icon.png',
		img: '/assets/images/projects/FiveLogs/Banner.png'
	},
	{
		title: 'CleanCopy',
		dateStart: new Date(2023, 9, 1),
